...
**********************************************************************
    ...
    DATA travels TYPE TABLE FOR READ RESULT ZR_13_TravelTP.
    DATA failed_travels TYPE RESPONSE for failed ZR_13_TravelTP.

    " Read Travels
    READ ENTITIES OF ZR_13_TravelTP IN LOCAL MODE
      ENTITY Travel
      FIELDS ( CustomerId )
  ...
  METHOD DetermineStatus.
    ...
    DATA travels TYPE TABLE FOR UPDATE ZR_13_TravelTp.
    ...
    MODIFY ENTITIES OF ZR_13_TravelTP IN LOCAL MODE
      ENTITY Travel
      UPDATE
      FIELDS ( Status )
      WITH travels.
